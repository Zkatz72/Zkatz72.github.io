    ...
    <div className="bg-gradient-to-b  text-neutral-900 from-green-400 to-white dark:bg-gradient-to-b dark:from-emerald-800 dark:to-[#121212]">
      <div className="flex mx-auto max-w-6xl items-center flex-row h-screen" >
        ...
        <p className=" dark:text-neutral-200 font-inter">
          ...
          <br></br>
          <br></br>Some of my interests include baseball, music, comedy, video
        ...
        <a href=""><div className = "my-4 p-1 flex justify-center items-center dark:bg-[#1d1d1d]  rounded-full w-10 h-10  transition-transform duration-300  bg-neutral-100  shadow dark:text-neutral-200 hover:scale-110"><FileText></FileText></div></a>
